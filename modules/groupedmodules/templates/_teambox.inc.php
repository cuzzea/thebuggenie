<li class="rounded_box mediumgrey borderless" style="padding: 0; margin-top: 5px;list-style: none;" id="setName_<?php echo $team->getID(); ?>">
    <div class="ui-slider-handle ui-state-default nested-sort-handel" style="width: 10px;height: 42px;float: left;cursor: move;"></div>
